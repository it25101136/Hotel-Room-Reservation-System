...
/** Abstract Payment class — Abstraction. Author: Member 4 */
...
//Abstract method for payment processing
   ...
   //Abstract method for payment type
    public abstract String getPaymentMethod();

    //Convert payment object into file format
    public String toFileString() {
        //Store payment data as text format
        return paymentId + "|" + reservationId + "|" + customerId + "|" + amount
                + "|" + status + "|" + paymentDate + "|" + getPaymentMethod();
    }
//Generate invoice details
    public String generateInvoice() {
        //Create invoice using Stringbuilder
        StringBuilder sb = new StringBuilder();

        //Add hotel and payment details
        sb.append("\n========== AURUM HOTEL INVOICE ==========\n");
