 ...
 * Abstract Room class - demonstrates Encapsulation
 * Parent class for StandardRoom, DeluxeRoom, SuiteRoom (Inheritance)
 */
public abstract class Room {
    ...
    // Polymorphism: Each room type calculates final price differently
    public abstract double calculateFinalPrice(int nights);

    // Convert room object to a single line for file storage
    ...
    public String toString() {
        return String.format("Room #%d | Type: %-15s | Price: LKR %,.2f | %s",
