...
/**
 * Component 04: Payment & Billing Management
 * Abstract Payment class - demonstrates Abstraction
 * Parent for CardPayment, CashPayment, OnlinePayment
 */
public abstract class Payment {
    ...
    /** Abstraction: Each payment method has its own processing logic */
    public abstract boolean processPayment();

    /** Polymorphism: Each method describes itself differently */
    ...
    public String toString() {
        return String.format("Payment #%d | Res:%d | Cust:%d | LKR %,.2f | %s | %s | %s",
