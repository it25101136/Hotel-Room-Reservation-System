...
/**
 * Tracks services selected by customers, linked to reservations.
 * Stored in customer_services.txt
 * Author: Member 6
 *
 * NOTE: This class is named "CustomerService" but lives in the `models` package.
 * It is unrelated to Member 3's `services.CustomerService` (the service-layer class).
 */
