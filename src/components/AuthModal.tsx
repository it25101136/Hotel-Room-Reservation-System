...
export default function AuthModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      // Admin and manager users should go directly to their dashboard/panel
      // and should NOT continue the pending public-site action.
      const staffRoles: typeof result.role[] = [
        "admin",
        "rooms-manager",
      ...
      if (result.role && staffRoles.includes(result.role)) {
        closeAuth();
        return;
      }
