...
public abstract class Customer extends User {
    ...
    private String customerType; // Customer type (REGULAR / VIP)
    ...
    public Customer(int id, String username, String password, String name,
        ...
        super(id, username, password, name, email, phone, "CUSTOMER");// Call parent User constructor
    ...
    public abstract double calculateDiscount(double amount);//Abstract method for discount calculation

    //onverts customer data into file format
